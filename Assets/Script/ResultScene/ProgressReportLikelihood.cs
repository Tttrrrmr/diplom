...
public class ProgressReportLikelihood : MonoBehaviour
{
    [Header("UI")]
    ...
    public int objectId = 6; // ← ID ПРЕДМЕТА
    public string subjectName = "Теория вероятностей и математическая статистика";
