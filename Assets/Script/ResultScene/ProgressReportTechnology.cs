...
public class ProgressReportTechnology : MonoBehaviour
{
    [Header("UI")]
    ...
    public int objectId = 4; // ← ID ПРЕДМЕТА
    public string subjectName = "Технология разработки и защиты баз данных";
